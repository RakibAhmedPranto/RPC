    ...
    <div class="container">
        <div class="row">
           <div class="col-md-6">
            ...
            <div class="col-md-6">
                <ul>
                    <li class="payment_icon"><a href="#"><img src="{{ asset('frontend/images/static/visa.png') }} " alt=""></a></li>
                    <li class="payment_icon"><a href="#"><img src="{{ asset('frontend/images/static/master.png') }} " alt=""></a></li>
                    <li class="payment_icon"> <a href="#"><img src="{{ asset('frontend/images/static/american.png') }}" alt=""></a></li>
                    <li class="payment_icon"><a href="#"><img src="{{ asset('frontend/images/static/master.png') }} " alt=""></a></li>
                </ul>
            </div>
        </div>
